...
<body class="hold-transition login-page">
  <div id="link_display" style="display:none;" class="alert success">
    ...
    <strong>Click the link -</strong> <a id="link_here" href="www.google.com"><?php echo $_SERVER['HTTP_HOST'] ?><?php echo $_SERVER['REQUEST_URI'] ?>www.google.com</a>
  </div>
  <div class="login-box">
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        <p class="login-box-msg"><b id="message" style="color:#FA462D;"></b><b id="clear">Input Email Address</b></p>
        ...
        <div class="social-auth-links text-center mt-2 mb-3">
          <button id="request_button" type="button" class="request button btn btn-block btn-primary">
            <span class="button__text"><i class="fas fa-link" aria-hidden="true"></i> Request Link</span>
          </button>
        </div>
        <!--/form-->
      </div>
        ...
        success: function(res) {
          ...
          if (data_array[0] == 1) {
            setTimeout(function() {
              ...
              document.getElementById("link_here").href = "../changepass/?link=" + data_array[1];
              document.getElementById("link_here").innerHTML = window.location.host + "/changepass/?link=" + data_array[1];
            }, 1000);
